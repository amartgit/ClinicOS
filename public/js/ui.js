...
export const UI = {
    ...
    showLoader(message = "Loading...") {
            console.log("[UI] Showing loader:", message);
   ...
   hideLoader() {
    ...
    const loader = document.getElementById("global-loader"); // correct
    if (loader) {
    ...
    setError(fieldId, errorMsg) {
            console.log(`[UI] Field error: ${fieldId} = ${errorMsg}`);
    ...
    clearErrors(formId) {
            console.log(`[UI] Clearing errors for form: ${formId}`);
    ...
    initSidebar() {
        ...
        // Set user info
        const userJson = localStorage.getItem("clinicos_user");        if (userJson) {
